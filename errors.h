...
ARRGEN_EXTERNC const char* program_name_;
...
*/
ARRGEN_EXTERNC void myErrorErrno(const char* restrict message, ...)
    ATTR_COLD
    ATTR_NONNULL_N(1)
    ATTR_NOTHROW
    ATTR_LEAF
 ...
 * @param message printf-formatted message string
*/
ARRGEN_EXTERNC void myError(const char* restrict message, ...)
    ATTR_COLD
    ATTR_NONNULL_N(1)
    ATTR_NOTHROW
    ATTR_LEAF
 ...
 * @param message printf-formatted message string
*/
ARRGEN_EXTERNC void myFatalErrno(const char* restrict message, ...)
    ATTR_COLD
    ATTR_NONNULL_N(1)
    ATTR_NOTHROW
    ATTR_LEAF
 ...
 * @param message printf-formatted message string
*/
ARRGEN_EXTERNC void myFatal(const char* restrict message, ...)
    ATTR_COLD
    ATTR_NONNULL_N(1)
    ATTR_NOTHROW
    ATTR_LEAF
